...
const Display = () => {
  return (
    <section className='w-full h-[80vh] flex md:flex-row flex-col items-center justify-center gap-16 pl-20 mt-4 overflow-hidden'> 
...
<div className="grid grid-cols-8 grid-rows-6 gap-4 w-1/2">
