  ...
  return (
    <div ref={aboutRef} className="bg-gray-100 px-10 md:px-20 w-full overflow-hidden">
      ...
      <div ref={textRef}>
          ...
          <span className="font-bold">CRC Joyous </span>is the divine abode where nature and the modern world coexist beautifully. It is an ideal living space that is surprisingly amplified with comfort in mind. This upcoming project has been designed in a sheer space with creativity and comfort in mind.<br />
